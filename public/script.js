          ...
          (async function() {
            try {
              ...
              const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                  websiteId: '2116e6ec-92e8-488e-ad3d-d7c563b3d98d',
                  name: name,
                  email: email,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "לבחור נכון משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2116e6ec-92e8-488e-ad3d-d7c563b3d98d';
